...
/*!********************************!*\
  !*** ./source/js/constants.js ***!
  \********************************/
/*! exports provided: possibleHashOptions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "possibleHashOptions", function() { return possibleHashOptions; });
const possibleHashOptions = {
  game: `game`,
  story: `story`,
  prizes: `prizes`,
  rules: `rules`,
...
/***/ "./source/js/modules/fpsRequestAnimationFrame.js":
/*!*******************************************************!*\
  !*** ./source/js/modules/fpsRequestAnimationFrame.js ***!
  \*******************************************************/
/*! exports provided: fpsRequestAnimationFrame */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fpsRequestAnimationFrame", function() { return fpsRequestAnimationFrame; });
const fpsRequestAnimationFrame = function (callback, initialFps = 12) {
  let now = 0;
  let delta = 0;
  let then = Date.now();
  let frames = 0;
...
/***/ "./source/js/modules/hashchange.js":
/*!*****************************************!*\
  !*** ./source/js/modules/hashchange.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constants */ "./source/js/constants.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const timer = Object(_timer__WEBPACK_IMPORTED_MODULE_1__["default"])();
  const handlerHashChange = () => {
    const {hash} = window.location;
    const transformedHash = hash.slice(1);

    switch (transformedHash) {
      case _constants__WEBPACK_IMPORTED_MODULE_0__["possibleHashOptions"].game:
        ...
        return null;
      case _constants__WEBPACK_IMPORTED_MODULE_0__["possibleHashOptions"].story:
      case _constants__WEBPACK_IMPORTED_MODULE_0__["possibleHashOptions"].prizes:
      case _constants__WEBPACK_IMPORTED_MODULE_0__["possibleHashOptions"].rules:
        return timer.stop();
      default:
        return null;
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sleep__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sleep */ "./source/js/modules/sleep.js");
...
const lettersBuilder = ({node = null, settings = {}}) => {
  ...
  const delayedStartAnimation = async (delay) => {
    await Object(_sleep__WEBPACK_IMPORTED_MODULE_0__["sleep"])(delay);
...
/* harmony default export */ __webpack_exports__["default"] = (lettersBuilder);
...
/* harmony import */ var _updatePrizesConter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./updatePrizesConter */ "./source/js/modules/updatePrizesConter.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  $screenOverlay.onanimationend = () => {
    ...
    window.requestAnimationFrame(() => Object(_updatePrizesConter__WEBPACK_IMPORTED_MODULE_1__["updatePrizesCounter"])($countPrizesCases, 1, 7));
    window.requestAnimationFrame(() => Object(_updatePrizesConter__WEBPACK_IMPORTED_MODULE_1__["updatePrizesCounter"])($countPrizesCodes, 11, 900));
  };
});
...
/***/ "./source/js/modules/textAnimation.js":
/*!********************************************!*\
  !*** ./source/js/modules/textAnimation.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lettersBuilder_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lettersBuilder.js */ "./source/js/modules/lettersBuilder.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../constants */ "./source/js/constants.js");



const createAnimation = (node, delay) => {
  const titleAnimation = Object(_lettersBuilder_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
    node,
  });
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const linkClickHandler = ({target}) => {
    ...
    const titleTag = href === _constants__WEBPACK_IMPORTED_MODULE_1__["possibleHashOptions"].top ? `h1` : `h2`;
    const title = screen.querySelector(titleTag);
    const delay = href === _constants__WEBPACK_IMPORTED_MODULE_1__["possibleHashOptions"].prizes ? 750 : 250;
  ...
  const pageLoadHandler = () => {
    const {hash} = window.location;
    const link = document.querySelector(`[href='${hash || `#${_constants__WEBPACK_IMPORTED_MODULE_1__["possibleHashOptions"].top}`}']`);
...
/* harmony default export */ __webpack_exports__["default"] = (timerBuilder);


/***/ }),

/***/ "./source/js/modules/updatePrizesConter.js":
/*!*************************************************!*\
  !*** ./source/js/modules/updatePrizesConter.js ***!
  \*************************************************/
/*! exports provided: updatePrizesCounter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updatePrizesCounter", function() { return updatePrizesCounter; });
/* harmony import */ var _fpsRequestAnimationFrame__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fpsRequestAnimationFrame */ "./source/js/modules/fpsRequestAnimationFrame.js");


let request = null;

const updatePrizesCounter = ($element, initialCounterValue, maxCounterValue) => {
  ...
  if (currentValue < maxCounterValue) {
    ...
    request = Object(_fpsRequestAnimationFrame__WEBPACK_IMPORTED_MODULE_0__["fpsRequestAnimationFrame"])(() => updatePrizesCounter($element, initialCounterValue, maxCounterValue));
  } else {
...
/* harmony import */ var _modules_screen_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/screen.js */ "./source/js/modules/screen.js");
...
/* harmony import */ var _modules_textAnimation_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/textAnimation.js */ "./source/js/modules/textAnimation.js");
...
/* harmony import */ var _modules_hashchange__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/hashchange */ "./source/js/modules/hashchange.js");
// modules
...
Object(_modules_screen_js__WEBPACK_IMPORTED_MODULE_8__["default"])();
...
Object(_modules_textAnimation_js__WEBPACK_IMPORTED_MODULE_11__["default"])();
Object(_modules_hashchange__WEBPACK_IMPORTED_MODULE_13__["default"])();
